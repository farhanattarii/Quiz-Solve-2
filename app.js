...
// Misal: Mazeed mashq ke liye, umar aur membership status ke hisab se chhote ya bara hisab laga sakte hain
function calculateDiscount(age, isMember) {
    var basePrice = 100; // Maal ki asal keemat
    var discount = 0;
    // Umar aur membership status ke hisab se elaj ki jaa rahi hai
    if (age >= 60 && isMember) {
        discount = 30; // Senior citizens jin ke sath membership hai, un ke liye 30% chhoot
    }
    else if (age >= 60 && !isMember) {
        discount = 20; // Senior citizens jo ke membership ke baghair hain, un ke liye 20% chhoot
    }
    else if (age < 60 && isMember) {
        discount = 10; // Non-senior citizens jin ke sath membership hai, un ke liye 10% chhoot
    }
    // Non-senior citizens jo ke membership ke baghair hain, un ke liye koi chhoot nahi (choot 0 rehti hai)
    var finalPrice = basePrice - (basePrice * (discount / 100));
    return finalPrice;
}
// Misal ke mohtaj
console.log(calculateDiscount(65, false));
console.log(calculateDiscount(70, false)); // Output: 80 (20% chhoot lagai gayi)
console.log(calculateDiscount(50, true)); // Output: 90 (10% chhoot lagai gayi)
